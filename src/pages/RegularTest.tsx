...
import { saveMeasurement, updateBatch, getActiveBatch, getRawSteelBySKU, saveTestData } from '../lib/db';
...
export default function RegularTest() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await saveTestData({
        ...
        testType: 'regular',
        result,
        topCoilData: topCoilDiffs.map(diff => ({
          height: calculateActualValue(diff)?.toString() || '',
          gauge: ''
        })),
        bottomCoilData: bottomCoilDiffs.map(diff => ({
          height: calculateActualValue(diff)?.toString() || '',
          gauge: ''
        }))
      });
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <ConfirmModal
          ...
          onConfirm={() => {
            ...
            navigate(`/machine/${machineId}/final-test`, {
              state: { 
